        ...
        <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((f) => (
            <MotionReveal key={f.title} className="rounded-2xl bg-white border border-gray-100 shadow-sm hover:shadow-lg transition-shadow transform-gpu hover:-translate-y-1 p-6">
              <div className="h-12 w-12 rounded-lg bg-[color:var(--blue-50)] flex items-center justify-center text-[color:var(--blue-700)] font-semibold text-lg">{f.title.charAt(0)}</div>
